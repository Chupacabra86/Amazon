...
class Books
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=CommandeDetail::class, mappedBy="book_id",cascade={"persist"})
     */
    ...
    public function removeCommandeDetail(CommandeDetail $commandeDetail): self
    {
        if ($this->commandeDetails->removeElement($commandeDetail)) {
            ...
            if ($commandeDetail->getBookId() === $this) {
                $commandeDetail->setBookId(null);
            }
        }
